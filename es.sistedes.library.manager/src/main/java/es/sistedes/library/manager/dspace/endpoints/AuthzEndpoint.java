...
public class AuthzEndpoint extends AbstractHateoas {

	public ResourcePoliciesEndpoint getResourcePoliciesEndpoint() {
		return DSpaceConnectionManager.buildClient().get().uri(getLinkUri("resourcepolicies").get()).retrieve().bodyToMono(ResourcePoliciesEndpoint.class).block();
	}
}
